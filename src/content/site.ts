export const site = {
  name: "satochan",
  tagline: "営業・採用の業務改善 / AI活用",
  description:
    "SES営業・採用の現場経験をもとに、AI活用、業務改善、Web・業務ツール開発まで。課題整理から設計、実装、運用まで一貫して取り組んでいます。",
  hero: {
    headline: "現場の課題を整理し、\nAIと仕組みで改善する。",
    sub: "SES営業約16年・採用約10年の現場経験をもとに、業務フローと判断基準を整理し、AI活用や小規模な業務ツールとして具体化しています。",
  },
} as const;
...
export const proofPoints: ProofPoint[] = [
  {
    ...
    unit: "年",
    label: "SES営業",
    note: "顧客需要・提案・接点・フォローの流れを理解する土台",
  },
  {
    value: "10",
    unit: "年",
    label: "採用",
    note: "候補者・求人・評価・選考進捗の流れを理解する土台",
  },
  {
    value: "1,500",
    unit: "+",
    label: "営業・商談接点",
    note: "企業・技術者との接点の累計。現場経験の厚みを示す活動量",
